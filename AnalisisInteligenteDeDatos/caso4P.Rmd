...
La función *train_test_split()* parte los datos originales el 70% y 30% para datos de entrenamiento y validación y con el argumento *datos.drop(columns = "Sales"), datos['Sales']* solo incluye las variables independientes; la semilla de aleatoriedad es 1271.

```{python}
X_entrena, X_valida, Y_entrena, Y_valida = train_test_split(datos.drop(columns = "Sales"), datos['Sales'],train_size=.70,  random_state=1271)
```
